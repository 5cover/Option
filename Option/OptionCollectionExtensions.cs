...
public static class OptionCollectionExtensions
{
    ...
    /// <summary>
    /// Attempts to retrieve the value associated with the specified key from the dictionary as a <see cref="ValueOption{TValue}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to retrieve the key-value pair associated with the specified key from the dictionary as a <see cref="ValueOption{KeyValuePair}"/>.
    /// </summary>
    /// <typeparam name="TKey">The type of the key in the dictionary.</typeparam>
    /// <typeparam name="TValue">The type of the value in the dictionary.</typeparam>
